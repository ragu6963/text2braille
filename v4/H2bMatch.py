...
def no_han_H2b(letter):
    if letter == '1':
        ...
        return ["000010/010000", 2]
    elif letter == ';':
        return ["000011/011000", 2]
...
def abbr_H2b(letter):
    if letter == "가":
        ...
        return {"data": "100000/011100/000000",
                "length": 3,
                "braille": "⠁⠎ "}
    elif letter == "그러면":
        return {"data": "100000/010010/000000",
                "length": 3,
                "braille": "⠁⠒ "}
    elif letter == "그러나":
        return {"data": "100000/100100/000000",
                "length": 3,
                "braille": "⠁⠉ "}
    elif letter == "그러므로":
        return {"data": "100000/010001/000000",
                "length": 3,
                "braille": "⠁⠢ "}
    elif letter == "그런데":
        return {"data": "100000/101110/000000",
                "length": 3,
                "braille": "⠁⠝ "}
    elif letter == "그리고":
        return {"data": "100000/101001/000000",
                "length": 3,
                "braille": "⠁⠥ "}
    elif letter == "그리하여":
        return {"data": "100000/100011/000000",
                "length": 3,
                "braille": "⠁⠱ "}
    elif letter == " ":
        return {"data": "000000",
